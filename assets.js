...
const wsFunctions = "<script src='/socket.io/socket.io.js'></script><script>const socket = io();socket.on('play', (msg) => {if (!msg.ping && msg.boardId === boardId) {$('#nextPicture').html(msg.next);}});</script>";
